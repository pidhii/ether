...
static uint8_t g_siphash_key[16] = {1, 2,  3,  4,  5,  6,  7,  8,
...
{
  static char sym[][5] = {"add",  "sub", "mul",  "div",  "mod",  "pow",
                          "land", "lor", "lxor", "lshl", "lshr", "ashl",
                          "ashr", "lt",  "le",   "gt",   "ge",   "eq",
                          "ne",   "is",  "eq",   "cons"};
  return sym[op];
}
...
eth_t
eth_system_error(int __attribute((unused)) err)
{
